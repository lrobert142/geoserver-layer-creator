...
public class RootLayoutController {
	...
	private void OpenShapeFiles() throws IOException {
		try {
			...
			try {
				...
				com.gov.aims.view.OverviewController controller = loader
						.getController();
	...
	private void ViewHelp() {
		try {
			...
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(MainApp.class
					.getResource("view/HelpDocView.fxml"));
			AnchorPane Overview = (AnchorPane) loader.load();
			// Set overview into the center of root layout.
			MainApp.rootLayout.setCenter(Overview);
			// Give the controller access to the main app.
			com.gov.aims.view.HelpController controller = loader
					.getController();
			controller.setMainApp(mainApp);
	...
	private void ViewAbout() {
		try {
			...
			MainApp.rootLayout.setCenter(Overview);
			// Give the controller access to the main app.
			com.gov.aims.view.AboutController controller = loader
					.getController();
			controller.setMainApp(mainApp);
